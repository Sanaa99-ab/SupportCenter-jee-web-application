		...
		<div id="layoutSidenav_content">
			<main>
				<div class="container-fluid px-4 mt-4">
					<h1>Edit shedule</h1>
					<form action="CenterManagerUpdateShedule" method="post">
						<div class="mb-3">
							<label>Course</label> 
							<input type="hidden" name="id" value="${requestScope.shedule.getId() }" />
						...
						<div class="mb-3">
							...
							<input type="number" name="day" class="form-control" value="${requestScope.shedule.getDayOfWeek() }" required/>
						</div>
						<div class="mb-3">
							<label>Start time</label>
							<input type="time" name="start" class="form-control" value="${requestScope.shedule.getStartTime() }" required/>
						</div>
						<div class="mb-3">
							<label>End time</label>
							<input type="time" name="end" class="form-control" value="${requestScope.shedule.getEndTime() }" required/>
						</div>
						<div>
